...
# -*- coding: utf-8 -*-
#
# multicell-parasite documentation build configuration file, created by
...
project = u'Multicellular Parasitism in Avida'
...
htmlhelp_basename = 'multicell-parasitedoc'
...
latex_documents = [
    (master_doc, 'multicell-parasite.tex',
     u'Multicellular Parasitism in Avida Documentation',
