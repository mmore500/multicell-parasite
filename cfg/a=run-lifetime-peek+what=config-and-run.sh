...
# should be r2000 + edundant with disabling indel mutations, but
...
u 0:100 PrintHostPhenotypeData
u 0:100 PrintParasitePhenotypeData

u 0:100 DumpHostTaskGrid
u 0:100 DumpParasiteTaskGrid

u 0:100 PrintHostTasksData
u 0:100 PrintParasiteTasksData

u 0:100 PrintParasiteData ParasiteData.dat
u 0:100 PrintAverageData       # Save info about the average genotypes
